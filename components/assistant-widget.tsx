...
export function AssistantWidget() {
  ...
  const submitLead = async (event: FormEvent<HTMLFormElement>) => {
    ...
    const payload = { name: form.get("name"), businessName: form.get("businessName"), email: form.get("email"), phone: form.get("phone"), consent: form.get("consent") === "on", privacyConsent: form.get("privacyConsent") === "on", assessment, blueprint: plan.blueprint, estimate: plan.estimate };
